...
object ExplicitResultTypesImports {
  ...
  val productWithSerializable: scala.collection.immutable.List[Product with fix.ExplicitResultTypesImports.ADT with java.io.Serializable] = List(ADT.A, ADT.B)
  ...
  val longSharedParent1: scala.collection.immutable.List[Product with fix.ExplicitResultTypesImports.ADT2 with fix.ExplicitResultTypesImports.Mixin[_ >: String with Int] with java.io.Serializable] = List(ADT2.A, ADT2.B)
  val longSharedParent2: scala.collection.immutable.List[Product with fix.ExplicitResultTypesImports.ADT2 with fix.ExplicitResultTypesImports.Mixin[Int] with java.io.Serializable] = List(ADT2.A, ADT2.C)
